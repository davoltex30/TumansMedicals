      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <div className="flex gap-2 mt-auto">
          <Link
            ...
            className="flex-1 inline-flex items-center justify-center gap-1.5 border border-[#c4c5d5] text-[#191c1e] rounded-lg text-sm font-bold px-3 py-2 hover:border-[#00288e] hover:text-[#00288e] transition-all"
          >
          ...
          <a
            ...
            className="flex-1 inline-flex items-center justify-center gap-1.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-lg text-sm font-bold px-3 py-2 transition-all"
          >
